...
\033[1;92m┃┃╱┃┃╱╱╱╱╱┃┃╱╱╱╱╱╱╱┃╭╮┃
\033[1;92m┃╰━╯┣━━┳━━┫┃╭┳━━┳━╮┃╰╯╰┳━━┳━━┳━━╮
\033[1;92m┃╭━╮┃╭╮┃╭━┫╰╯┫┃━┫╭╯┃╭━╮┃╭╮┃━━┫━━┫ 03155538375
\033[1;92m┃┃╱┃┃╭╮┃╰━┫╭╮┫┃━┫┃╱┃╰━╯┃╰╯┣━━┣━━┃
\033[1;92m╰╯╱╰┻╯╰┻━━┻╯╰┻━━┻╯╱╰━━━┻━━┻━━┻━━╯                                            
\033[1;97m-----------------------------------------------
\033[1;91m➣ OWNER   : RaheemUllah Mafia Boss
\033[1;91m➣ Github  : https://github.com/HackerBoss
\033[1;91m➣ GANG    : PMF 420 GANG
\033[1;91m➣ Youtube : Hacker Boss
\033[1;91m➣ WhatsApp: 03155538375
\033[1;97m-----------------------------------------------"""
# titik #
def tik():
	titik = [".   ","..  ","... "]
...
def menu():
	...
	try:
		...
		os.system('python2 Boss.py')
	try:
		otw = requests.get('https://graph.facebook.com/me?access_token='+yes)
	...
	print "[5] Update Raheemullah Tool."
...
def men():
	...
	if rana =="":
		...
		time.sleep(3)
		os.hamza('python2 Boss.py')
	elif rana =="6":
		os.system('xdg-open https://www.facebook.com/profile.php?id=100022583654474')
		menu()
	elif rana =="7":
		os.system('rm -rf login.txt')
